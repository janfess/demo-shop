...
const ProductEdit = () => {
  ...
  return (
    <>
      <Link to='/admin/productlist' className='btn btn-light mt-3 mb-3'>
        Go Back
      </Link>
      <FormContainer>
        <h1>Edit Product</h1>
        ...
        {isLoading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group className='mt-2 mb-2' controlId='image'>
            ...
            <Form.Group className='mt-2 mb-2' controlId='countInStock'>
            ...
            <Form.Group className='mt-2 mb-2' controlId='category'>
