...
// Auth user & get token @route POST /api/users/auth @access Public
...
// Register a new user @route POST /api/users @access Public
...
// Logout user / clear cookie @route POST /api/users/logout @access Public
